...
import 'package:flutter_hello_world/data/days.dart';
import 'package:flutter_hello_world/data/professors.dart';
import 'package:flutter_hello_world/data/timetable.dart';
import 'package:flutter_hello_world/ui/AllNotifsProf.dart';
import 'package:flutter_hello_world/ui/ChoosePage.dart';
import 'package:flutter_hello_world/ui/SendNotification.dart';
import 'package:provider/provider.dart';

import 'package:shared_preferences/shared_preferences.dart';


class ScheduleProfPage extends StatefulWidget {
  final FirebaseUser currentUser;
  ScheduleProfPage(this.currentUser);
  @override
  _ScheduleProfPage createState() => _ScheduleProfPage();
}

class _ScheduleProfPage extends State<ScheduleProfPage> {
        ...
        child: ListView(
          children: <Widget>[
            ...
            InkWell(
              ...
              child: ListTile(
                ...
                onTap: () async{
                  ...
                  Navigator.push(context, new MaterialPageRoute(builder: (context) => ChoosePage(currentUser)));
            ...
            InkWell(
              ...
              child: ListTile(
                ...
                onTap: () async{
                  FirebaseUser currentUser =
                  await Provider.of<AuthService>(context).getUser();
                  Navigator.push(context, new MaterialPageRoute(builder: (context) => SendNotification(currentUser)));
            ...
            InkWell(
              ...
              child: ListTile(
                leading: Icon(Icons.calendar_today),
                title: Text('Toutes Notifications'),
                onTap: () async{
                  FirebaseUser currentUser =
                  await Provider.of<AuthService>(context).getUser();
                  Navigator.push(context, new MaterialPageRoute(builder: (context) => AllNotifsProf(currentUser)));
