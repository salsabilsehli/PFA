...
class SendNotification extends StatefulWidget {
  ...
  SendNotification(this.currentUser);

  @override
  State<StatefulWidget> createState() => _SendNotificationState();
}
            ...
            children: <Widget>[
              ...
              RaisedButton(
                ...
                child: Container(
                  ...
                  child:
                  const Text('Envoyer Notification', style: TextStyle(fontSize: 20)),
                ),
              ),
                  ...
                  onPressed: () async {
                    ...
                    if(_niveau.toString()=="Niveau.G1"){
                      if(_section.toString()=="Section.S1"){
                       // await Databaseservice(currentUser.uid).ProfsendnotifGI1S1(currentUser.email,_eventController.text);

                            if(currentUser.email=="nom.prenom@enis.tn") {

                              await Databaseservice(currentUser.uid)
                                  .nomsprenomendnotiflihGI1S1(
                                  currentUser.uid + _eventController.text,
